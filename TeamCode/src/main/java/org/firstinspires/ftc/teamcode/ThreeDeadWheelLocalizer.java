...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1319.3519895003901; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1593.9928779496765; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -480.88431553326257; // x position of the perpendicular encoder (in tick units)
    }
